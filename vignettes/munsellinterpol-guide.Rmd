...
or corrections to make the data smoother.
...
For **10PB 8/4**  it looks like @ASTM-D1535-97 made a smoothing correction,
which was carried over to @renotationRIT.
For **2.5R 9/2** it looks like @renotationRIT made a smoothing correction.

Finally, in the extrapolated data in @renotationRIT, we have made a small
smoothing corection at **2.5PB 10/2** for this package.
Before the correction, the forward mapping HVC $\to$ xyY was not injective
